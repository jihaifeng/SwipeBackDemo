...
package com.jihf.swipbackhelper;
...
public class ViewDragHelper {
  ...
  private boolean checkNewEdgeDrag(float delta, float odelta, int pointerId, int edge) {
    ...
    if ((mInitialEdgeTouched[pointerId] & edge) != edge
  ...
  private void releaseViewForPointerUp() {
    ...
    final float xvel =
        clampMag(VelocityTrackerCompat.getXVelocity(mVelocityTracker, mActivePointerId), mMinVelocity, mMaxVelocity);
    final float yvel =
